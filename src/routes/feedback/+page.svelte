...
<main class="min-h-screen flex flex-col">
	<section class="flex flex-row justify-between items-center bg-accent p-6 md:p-16 shadow-2xl">
		...
		<button
			...
			on:click={() => window.open('https://app.herotofu.com/forms/2aedf4a0-a7cf-11ed-a31e-753411848f80/submissions', 'Feedback Results', 'width=1000,height=800')}
		>
			<svg class="h-4 translate-y-[-0.1rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" fill="#fff">
				<path
